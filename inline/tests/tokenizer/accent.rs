...
pub fn test_tokenize__verbatim_with_escaped_char() {
  ...
  let expected = [
    Token{ kind: TokenKind::VerbatimOpen, content: "`".to_string(), position: Position { line: 0, column: 0 } },
    Token{ kind: TokenKind::Plain, content: "text".to_string(), position: Position { line: 0, column: 1 } },
    Token{ kind: TokenKind::EscapedGrapheme, content: "&".to_string(), position: Position { line: 0, column: 5 } },
    Token{ kind: TokenKind::Plain, content: "text".to_string(), position: Position { line: 0, column: 7 } },
    Token{ kind: TokenKind::VerbatimClose, content: "`".to_string(), position: Position { line: 0, column: 11 } },
  ];
